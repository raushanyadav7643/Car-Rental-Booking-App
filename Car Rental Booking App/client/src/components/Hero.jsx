...
const Hero = () => {
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center gap-10 bg-light text-center">
      ...
      <form className="flex flex-col md:flex-row items-start md:items-center justify-between p-4 rounded-lg md:rounded-full w-full max-w-80 md:max-w-185 bg-white shadow-[0px_10px_20px_rgba(0,0,0,0.1)]">
      ...
      <img src={assets.main_car} alt="car" className="max-h-70" />
    </div>
  );
};
